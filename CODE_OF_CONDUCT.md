...
participation in `forgesworn/anvil` a harassment-free experience for
...
action in response to any behaviour that they deem inappropriate,
...
may be reported by opening an issue on the repository at
<https://github.com/forgesworn/anvil/issues>. For sensitive reports
that should not be public, use GitHub Security Advisories at the
repository's Security tab; conduct issues will be routed to the
maintainers.
